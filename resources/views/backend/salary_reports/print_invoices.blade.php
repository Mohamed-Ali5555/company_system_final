                                                    ...
                                                    {{-- @if ($salary_reports->count() > 0)
                                                        ...
                                                        @foreach ($salary_reports as $salary_report) --}}
                                                            ...
                                                            <tr>
                                                                ...
                                                                {{-- <td> {{ $salary_reports->report_date }}</td> --}}
                                                                ...
                                                                <td> {{ $salary_reports->employer->hour_price }}</td>
                                                                <td> {{ $salary_reports->total_attendace_days }}</td>
                                                                {{-- <td> {{ $salary_reports->total_absent_days }}</td> --}}
                                                                {{-- <td> {{ $salary_reports->total_hours_discount }}</td> --}}

                                                                <td> {{ $salary_reports->total_hours_overtime }}</td>
                                                                <td> {{ $salary_reports->total_hours_amount }}</td>
