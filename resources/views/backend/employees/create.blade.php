                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title-wrap bar-success">
                                            <h4 class="card-title" id="horz-layout-basic">Add Employees Form</h4>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="px-3"  onChange="javascript:myFunction()">
                                            ...
                                            <form class="form form-horizontal" action="{{ route('employees.store') }}"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="number" id="hour_price" class="form-control"
                                                            name="hour_price" value="{{ old('hour_price') }}" >
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="projectinput11">National
                                                        ID: </label>
                                                    <div class="col-md-9">
                                                        <input type="number" id="projectinput11" class="form-control"
